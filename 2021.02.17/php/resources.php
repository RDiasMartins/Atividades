<?php
    ...
    if(!empty($_POST)){
        ...
        if($vazio){
                        ...
                        if(mysqli_num_rows($resultado) == 1){
                            ...
                            if($stmt = mysqli_prepare($conexao, $sql)){
                                ...
                                if(mysqli_num_rows($resultado) == 1){
                                    ...
                                    echo '{"code":400, "message": "Valores não encontrados"}';
                                }
                            }else{
                                echo '{"code":400, "message": "Falha ao se comunicar com o database"}';
                            }
                        }
                    }else{
                        echo '{"code":400, "message": "Falha ao se comunicar com o database"}';
            ...
            echo '{"code": 400, "message": "Requisição com parâmetros nulos"}';
        }
    }else{
        echo '{"code": 400, "message": "Requisição com falta do POST"}';
    }
?>
