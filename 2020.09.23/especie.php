<?php
    ...
    $select = "SELECT especie.nome, especie.nome_cientifico as nome_cientifico_especie, genero.nome_cientifico 
        as nome_cientifico_genero, familia.nome_cientifico as nome_cientifico_familia FROM genero INNER JOIN familia 
        ON genero.cod_familia = familia.id_familia INNER JOIN especie ON especie.cod_genero=genero.id_genero";
